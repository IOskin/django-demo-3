...
3. Выполнение миграций и создание БД

```commandline
python manage.py migrate
```

4. Импорт исходных данных из Excel

В корне проекта должен лежать файл `Прил_2_ОЗ_Канцтовары-M1.xlsx`.  
Для загрузки товаров и связанных справочников в базу данных используется management-команда:
...
- находит в Excel лист с товарами;
- читает строки и создаёт записи в таблице `Product` и связанных таблицах (`Category`, `Manufacturer`, `Supplier`).
